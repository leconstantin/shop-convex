...
export function StoreDashboard() {
  ...
  const createDummyProducts = useMutation(api.products.createDummyProducts);
  ...
  const handleCreateStore = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createDummyProducts({ storeId });
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm border p-8">
          ...
          <p className="text-gray-600 mb-6">You can only own one store. Create it now to start selling!</p>
